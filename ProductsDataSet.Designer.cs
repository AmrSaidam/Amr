...
namespace ManageStock.ProductsDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price) AND ([Date" +
                "] = @Original_Date))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Amount] = @Amount, [Price] = @Price, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price) AND ([Date] = @Original_Date));
SELECT Id, Name, Amount, Price, Date FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ManageStock.Properties.Settings.Default.ProductsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, Name, Amount, Price, Date FROM dbo.[Table]";
        ...
        public virtual int FillBy(ProductsDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Amount, double Original_Price, System.DateTime Original_Date) {
        ...
        public virtual int Insert(string Name, int Amount, double Price, System.DateTime Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Amount, double Price, System.DateTime Date, int Original_Id, string Original_Name, int Original_Amount, double Original_Price, System.DateTime Original_Date, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Amount, double Price, System.DateTime Date, int Original_Id, string Original_Name, int Original_Amount, double Original_Price, System.DateTime Original_Date) {
